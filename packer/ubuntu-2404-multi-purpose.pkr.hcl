...
build {
    ...
    provisioner "shell" {
        inline = [
            ...
            "cd /tmp",
            "wget https://github.com/derailed/k9s/releases/download/v0.50.12/k9s_Linux_amd64.tar.gz",
    ...
    provisioner "shell" {
        inline = [
            ...
            # Download the package information from the HashiCorp repository and install terraform and packer
            "sudo apt update",
